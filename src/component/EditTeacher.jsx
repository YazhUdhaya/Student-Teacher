...
function EditTeacher() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
     await axios.put(`https://630b1174f280658a59d58092.mockapi.io/teacher/${params.id}`,values)
  ...
  let loadUser = async () => {
    try {
      let teacher = await axios.get(`https://630b1174f280658a59d58092.mockapi.io/teacher/${params.id}`)
      formik.setValues(
        {
